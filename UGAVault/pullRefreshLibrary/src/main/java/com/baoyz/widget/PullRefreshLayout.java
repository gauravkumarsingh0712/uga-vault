...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.PullRefreshLayout_refreshType, STYLE_MATERIAL);
        final int colorsId = a.getResourceId(R.styleable.PullRefreshLayout_refreshColors, R.array.google_colors);
        a.recycle();
